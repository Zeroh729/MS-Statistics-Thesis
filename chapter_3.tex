...
\end{equation}
Further expanding its composition, as based on \citeA{Kung2004}, the incomplete-data log-likelihood can be obtained as a sum of two terms derived as follows:
\begin{equation*}
    \begin{aligned}
...
To assist in the derivation of the complete-data likelihood, the indicator variable \(\delta_{i}^{(g)}\) was adopted from the notation of \citeA{Kung2004} and is introduced to express the status of the hidden states as
\begin{equation*}
